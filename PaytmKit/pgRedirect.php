...
$query = "update tblorders set OrderNumber='$orderid',IsOrderPlaced='1', payment_mode='ONLINE' where UserId='$userid' and IsOrderPlaced is null;";
...
$paramList["CALLBACK_URL"] = "http://localhost/fos/PaytmKit/pgResponse.php";
/*
