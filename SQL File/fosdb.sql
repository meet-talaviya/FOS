...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 03, 2022 at 08:28 AM
...
(1, 'Admin', 'admin', 7894561238, 'test@gmail.com', '87e88735ee72827b11a2e4dc9dac19de', '2021-04-04 18:30:00');
...
--
-- Table structure for table `tbleusertransaction`
--

CREATE TABLE `tbleusertransaction` (
  `ORDERID` bigint(20) NOT NULL,
  `STATUS` varchar(255) NOT NULL,
  `TXNID` varchar(255) NOT NULL,
  `PAYMENTMODE` varchar(255) NOT NULL,
  `BANKTXNID` varchar(255) NOT NULL,
  `TXNAMOUNT` bigint(20) NOT NULL,
  `BANKNAME` varchar(255) NOT NULL,
  `TXNDATE` datetime NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `tbleusertransaction`
--

INSERT INTO `tbleusertransaction` (`ORDERID`, `STATUS`, `TXNID`, `PAYMENTMODE`, `BANKTXNID`, `TXNAMOUNT`, `BANKNAME`, `TXNDATE`) VALUES
(362902082, 'TXN_SUCCESS', '20220403111212800110168380603555444', 'NB', '10148254793', 190, 'State Bank of India', '2022-04-03 11:55:22');
...
(1, '5', '362902082', '80', 'Vijayanagar -1 ', 'pandesara', '', 'Surat', '2022-04-03 06:25:23', NULL);
...
(5, 'shreyas', 'solanke', 'shreyas@gmail.com', 8787878777, '202cb962ac59075b964b07152d234b70', '2022-04-01 17:33:52');
...
--
-- Indexes for table `tbleusertransaction`
--
ALTER TABLE `tbleusertransaction`
...
--
-- AUTO_INCREMENT for table `tbleusertransaction`
--
ALTER TABLE `tbleusertransaction`
  MODIFY `ORDERID` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=362902083;
